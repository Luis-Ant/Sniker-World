...
export default function UserMenu({ username, onLogout, onClose }) {
  return (
    <div className="absolute right-0 mt-50 w-48 bg-white border rounded-md shadow-xl z-20">
      <div className="py-2">
        ...
        <button
          ...
          className="block w-full text-left px-4 py-2 text-ld text-red-500 hover:bg-red-100 transition"
        >
          Cerrar Sesión
        </button>
      </div>
